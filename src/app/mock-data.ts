export const PERSONAL_INFO = {
    ...
    personality: {
      type: "INTJ",
      traits: ["Innovative", "Strategic", "Analytical", "Independent"]
    },
    favoriteColors: ["#3498db", "#2ecc71", "#e74c3c"],
    hobbies: [
    ...
    funFact: "I once coded for 48 hours straight to win a hackathon!",
    currentlyLearning: "Machine Learning and AI",
    lifeGoal: "To create technology that positively impacts millions of lives"
  };
